...
import { Image, Heading, RowType, Toggle, Text } from '@soy-libs/uikit'
...
const Farms: React.FC = () => {
  ...
  const [viewMode, setViewMode] = usePersistState(ViewMode.TABLE, 'soy_farm_view')
  ...
  const rowData = farmsStakedMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('SOY', '')
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <StyledImage src="/images/3dpan.png" alt="soy illustration" width={120} height={103} />
      </Page>
    </>
  )
}
