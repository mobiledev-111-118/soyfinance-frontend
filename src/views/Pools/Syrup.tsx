...
import { Heading, Flex, Button, Text, HelpIcon, Link } from '@soy-libs/uikit'
...
const Syrup: React.FC = () => {
  ...
  const [stakedOnly, setStakedOnly] = usePersistState(false, 'soy_pool_staked')
    ...
    <>
      <PageHeader>
        <Flex justifyContent="space-between">
          ...
          <Flex>
            <StyledLink color="backgroundAlt" href="https://docs.soyswap.finance/syrup-pools/syrup-pool" external>
