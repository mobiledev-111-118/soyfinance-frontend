...
import { Text, Flex, Box, Image, CheckmarkCircleIcon, FlexProps, HelpIcon, useTooltip } from '@soy-libs/uikit'
    ...
    if (account && !hasProfile) {
      return (
        <Text textAlign="center">
          {TranslateString(999, 'You need an active SoySwap Profile to take part in an IFO!')}
        </Text>
      )
    }
