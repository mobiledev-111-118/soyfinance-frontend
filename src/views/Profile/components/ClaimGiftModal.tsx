...
import { Modal, Text, InjectedModalProps, Button, AutoRenewIcon } from '@soy-libs/uikit'
  ...
  return (
    <Modal title={TranslateString(999, 'Claim your Gift!')} onDismiss={onDismiss}>
      <div style={{ maxWidth: '640px' }}>
        <Text as="p">{TranslateString(999, 'Thank you for being a day-one user of Soy Profiles!')}</Text>
        <Text as="p" mb="8px">
          {TranslateString(
            999,
