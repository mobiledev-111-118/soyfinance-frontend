...
import { Button, InjectedModalProps, Skeleton, Text } from '@soy-libs/uikit'
    ...
    <>
      ...
      {!isLoading && nftsInWallet.length === 0 && (
        <>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {TranslateString(999, 'Make sure you have a Soy Collectible in your wallet and try again!')}
          </Text>
        </>
      )}
